<?php 
    ...
    class PDF extends FPDF
    {
        ...
        foreach($productLists as $row){
            ...
            $this->Cell(15,9,$row["total_Qty"],"R",0,"C");
            $this->Cell(15,9,number_format(($row["Cost"]*0.07), 2),"R",0,"C");
            $this->Cell(25,9,number_format($total+($row["Cost"]*0.07), 2),"R",0,"R");
            $this->Cell(25,9,number_format($profit, 2),"R",1,"R");
            $all_qty += $row["total_Qty"];
            $all_total += ($total+($row["Cost"]*0.07));
            $all_pofit += $profit;
            $all_tax += ($row["Cost"]*0.07);
        ...
        $this->Cell(15,9,$all_qty,1,0,"C");
        $this->Cell(15,9,number_format($all_tax, 2) ,1,0,"C");
